...
export default function ParalaxSection () {
    return (
        <>
        <div id='paralaxImage' className="justify-center h-full w-full">
            <div className="xl:w-10/12 mx-auto px-6 xl:px-0 mt-16">
                <div className="mx-auto w-full text-center">
                        <div className="py-36">
                            <h3 className="text-white font-semibold text-xl mb-2">From <span className="text-orange-650">$ 980</span></h3>
                            <h1 className="capitalize text-white text-4xl font-bold tracking-wide">sarova whitesands beach resort & spa </h1>
                            <div className="flex justify-center">
                                <ul className="mt-4 flex flex-row">
                                  <li className="flex flex-row text-white"> <span className="mr-2"><svg className="w-4 h-6 text-white rounded-full text-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    </svg></span> Mombasa </li>
                                  <li className="text-white ml-6"> <span> | </span> </li>
                                  <li className="text-white ml-6 flex flex-row"><span className="mr-2"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                        </svg></span> August 20th </li>
                                </ul>
                            </div>
                            ...
                            <h4 className="capitalize text-white font-medium ml-2">17 reviews</h4>
                            </div>
                            <p className="text-white mt-4">Visit our breath taking well established campsites and tented camps, for quality vacations, trips, met with complementary explorations and discoveries.</p>
                            <div className="mt-12">
                                <Link href='/#'>
                                    <a className="text-white bg-orange-650 p-2 rounded-md capitalize font-semibold">view our tours</a>
                                </Link>
                            </div>
                        </div>
                    </div>
